<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Search.aspx.cs" Inherits="Search" Title="商品搜索" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <asp:GridView ID="gvProduct" runat="server" AutoGenerateColumns="false" Width="100%"
        ...
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>
                    <table width="100%" border="1" cellpadding="6" cellspacing="4" bordercolor="#CCCCCC">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblListPrice" runat="server" ForeColor="Red" Text='<%# Bind("ListPrice") %>'></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
